package shencai.commonsample.ui.fg1content.pullzoomview;
...
/**
 * Created by yss on 2017/9/19
 *
 * @version 1.0.0
 */
public class PullMainActivity extends AppCompatActivity
		implements AdapterView.OnItemClickListener, SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pullmain);
