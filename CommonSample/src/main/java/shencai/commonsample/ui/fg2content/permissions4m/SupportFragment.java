...
public class SupportFragment extends Fragment {
    ...
    public void contactGranted() {
        ToastUtil.showShort(getActivity(),"读取地理位置权限成功 in fragment");
    }

    @PermissionsDenied(LOCATION_CODE)
    public void contactDenied() {
        ToastUtil.showShort(getActivity(),"读取地理位置权限失败 in fragment");
    }

    @PermissionsRationale(LOCATION_CODE)
    public void contactRationale() {
        ToastUtil.showShort(getActivity(),"请开启读取地理位置权限 in fragment");
    }

    //====================================================================
    @PermissionsGranted(CAMERA_CODE)
    public void cameraGranted() {
        ToastUtil.showShort(getActivity(),"相机权限授权成功 in fragment");
    }

    @PermissionsDenied(CAMERA_CODE)
    public void cameraDenied() {
        ToastUtil.showShort(getActivity(),"相机权限授权失败 in fragment");
    }
