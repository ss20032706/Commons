package cc.shencai.commonlibrary.ncalendar.calendar;
...
import cc.shencai.commonlibrary.ncalendar.listener.OnMonthCalendarChangedListener;
import cc.shencai.commonlibrary.ncalendar.listener.OnWeekCalendarChangedListener;
import cc.shencai.commonlibrary.ncalendar.utils.Attrs;
...
public class NCalendar extends FrameLayout implements NestedScrollingParent, ValueAnimator.AnimatorUpdateListener, OnWeekCalendarChangedListener, OnMonthCalendarChangedListener {
	 ...
	 *
	 */
	public void setPoint(HashMap<String,Integer> hashMapPoint) {
		monthCalendar.setPointList(hashMapPoint);
		weekCalendar.setPointList(hashMapPoint);
	}
	 ...
	 * @param isShow
	 */
	public void isShowLunar(boolean isShow) {
		Attrs.isShowLunar = isShow;
	}

	/**
	 * 设置公历日期的文本颜色
	 */
	public void setSolarTextColor(int color) {
		Attrs.solarTextColor = color;
	}
	...
	public void setLunarTextColor(int color) {
		Attrs.lunarTextColor = color;
	}

	/**
	 * 设置公历日期的文本大小
	 */
	public void setsolarTextSize(int color) {
		Attrs.solarTextSize = color;
	}

	/**
	 * 设置农历日期的文本大小
	 */
	public void setLunarTextSize(int color) {
		Attrs.lunarTextSize = color;
	}
	...
	public void setSelectCircleColor(int color) {
		Attrs.selectCircleColor = color;
	}

	/**
	 * 设置选中和当天圆环半径
	 */
	public void setSelectCircleRadius(int color) {
		Attrs.selectCircleRadius = color;
	}

	/**
	 * 设置选中空心圆中间的颜色
	 */
	public void setHollowCircleColor(int color) {
		Attrs.hollowCircleColor = color;
	}

	/**
	 * 设置选中空心圆圆环粗细
	 */
	public void setHollowCircleStroke(int color) {
		Attrs.hollowCircleStroke = color;
	}
	 ...
	 * 设置每周第一天是周日还是周一;
	 *
	 * @param style NCalendar.SUNDAY:周日  NCalendar.MONDAY: 周一
	 */
	public void setFirstDayOfWeek(int style) {
		Attrs.firstDayOfWeek = style;
	}

	/**
	 * 设置NCalendar日历默认视图是周视图还是月视图
	 *
	 * @param style NCalendar.WEEK:周视图 NCalendar.MONTH：月视图
	 */
	public void setDefaultCalendar(int style) {
		Attrs.defaultCalendar = style;
	}
	 ...
	 * @param color
	 */
	public void setHolidayColor(int color) {
		Attrs.holidayColor = color;
	}
	 ...
	 * @param color
	 */
	public void setWorkdayColor(int color) {
		Attrs.workdayColor = color;
	}
