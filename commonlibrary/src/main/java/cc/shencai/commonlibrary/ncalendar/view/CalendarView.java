...
public abstract class CalendarView extends View {
    ...
    protected HashMap<String,Integer> hashMapPoint;
    ...
    public void setDateTimeAndPoint(DateTime dateTime, HashMap<String,Integer> hashMapPoint) {
        this.mSelectDateTime = dateTime;
    ...
    public void setPointList(HashMap<String,Integer> hashMapPoint) {
        this.hashMapPoint = hashMapPoint;
        invalidate();
    }
